...
<div class="login-box">
    <form action="index.php?c=admin&a=login_action" method="post" class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="username" class="layui-input" lay-verify="required" placeholder="请输入账号" autofocus="autofocus" value="">
            </div>
        </div>
        <div class="layui-form-item">
